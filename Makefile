...
SRCS	=	$(addprefix mandatory/, gnl/get_next_line.c gnl/get_next_line_utils.c \
			...
			parsing/parsing5.c parsing/parsing1.c parsing/parsing2.c parsing/parsing3.c parsing/parsing0.c parsing/move_player.c \
...
BONUS_SRCS =    $(addprefix bonus/, gnl/get_next_line.c gnl/get_next_line_utils.c \
				...
				parsing/parsing5.c parsing/parsing1.c parsing/parsing2.c parsing/parsing3.c parsing/parsing0.c parsing/move_player.c parsing/move_utils.c \
				parsing/check/check_map.c parsing/check/che_map_utils.c parsing/check/check_utils.c\
